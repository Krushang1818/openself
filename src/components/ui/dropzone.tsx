...
export function Dropzone({
  ...
  return (
    <div
      {...getRootProps()}
      className={cn(
        "border-2 border-dashed rounded-lg p-16 text-center flex flex-col items-center justify-center gap-2 cursor-pointer transition-colors relative",
    ...
    >
      ...
      {files.length > 0 ? (
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-base font-bold mt-2">{files[0].name}</div>
