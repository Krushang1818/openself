    ...
    <div className="min-h-screen p-8 flex flex-col items-center justify-center font-[family-name:var(--font-geist-sans)]">
      <main className="max-w-2xl w-full space-y-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-4xl text-center">Cursor for Resumes</h1>
          <p className="text-lg text-gray-600 text-center mt-2">AI-powered resume builder</p>
        </div>
          ...
          <div className="bg-white px-8 py-4">
            ...
            <ApiKeyCheck>
              <div className="flex gap-4 flex-wrap">
                ...
                <a
                  href="/interactables"
                  className="px-6 py-3 rounded-md font-medium shadow-sm transition-colors text-lg mt-4 bg-[#E17FFF] hover:bg-[#d570f5] text-gray-800"
                >
                  Interactables Demo →
                </a>
              </div>
