      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Create professional, ATS-friendly resumes in minutes using advanced AI.
            Stand out from the crowd with personalized content that highlights your unique skills and achievements.
          </p>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">Generate compelling descriptions and optimize your resume for ATS systems.</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">Choose from multiple professionally designed templates that get results.</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600">Export your resume as PDF instantly and start applying to jobs right away.</p>
          </div>
        </div>
      </main>
    </div>
